...
(() => {
  ...
  // Build a chevron arrow SVG via DOM (no innerHTML).
  const buildChevron = (direction) => {
    ...
    path.setAttribute('d', direction === 'left' ? 'M10 3L5 8l5 5' : 'M6 3l5 5-5 5');
  ...
  class DeckStage extends HTMLElement {
    ...
    _render() {
      ...
      // Overlay built via createElement (no innerHTML).
      ...
      resetBtn.setAttribute('aria-label', 'Reset to first slide');
      ...
      overlay.append(prevBtn, count, nextBtn, div, resetBtn);
